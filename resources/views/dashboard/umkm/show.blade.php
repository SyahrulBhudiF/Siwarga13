...
@section('content')
    <div class="flex w-full p-[3.75rem]">
        <p class="text-Primary/10 font-medium text-xl">UMKM</p>
    </div>
    <div class="lg:grid lg:grid-cols-2 lg:gap-[3.75rem] w-full px-[3.75rem] pb-[3.75rem]">
        <x-etc.slider :dt="$data['umkm']->file"></x-etc.slider>
        <div class="flex flex-col gap-5 w-full">
            <p class="text-Neutral/100 text-2xl font-medium">{{$data['umkm']->judul}}</p>
            <div
                class="lg:grid lg:grid-cols-2 items-center gap-3 border-b border-b-Neutral/30 pb-[1.25rem] mb-[1.25rem]">
