<div class="flex flex-col justify-between w-full h-full overflow-hidden fade-in xl:overflow-y-auto lg:overflow-x-auto">
    ...
    @if (Route::currentRouteName() !== 'bansos.show')
        <div class="flex justify-between 2xl:my-0 xl:my-4 items-center" id="pagin">
