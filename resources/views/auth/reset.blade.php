...
<main
    ...
    <header class="flex flex-col gap-8 w-full">
        ...
        <p class="text-Neutral/100 text-4xl max-sm:text-3xl font-medium">Reset Password</p>
    </header>
    <form action="{{route('forgot-password.send')}}" method="post" class="w-full flex flex-col gap-3">
        @csrf
